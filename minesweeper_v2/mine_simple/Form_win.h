...
namespace minesimple {
	...
	public ref class Form_win : public System::Windows::Forms::Form
	{
	public:
		Form_win(void)
		{
	...
	#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Form_win::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Form_win::button2_Click);
			// 
			// label2
			// 
			...
			this->Text = L"提示窗";
			this->Load += gcnew System::EventHandler(this, &Form_win::Form_win_Load);
...
#pragma endregion
		...
		private: System::Void Form_win_Load(System::Object^ sender, System::EventArgs^ e) {
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Form_win::wForm_Closing);
		}
